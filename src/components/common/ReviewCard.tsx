...
const ReviewCard = ({
  ...
  return (
    <div
      className={cn([
        "relative bg-white flex flex-col items-start aspect-auto border-[3px] border-black rounded-none p-6 sm:px-8 sm:py-7 overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] cursor-grab active:cursor-grabbing",
        className,
      ])}
    >
      {blurChild && blurChild}
