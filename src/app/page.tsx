...
export const reviewsData: Review[] = [
  {
    ...
    user: "Alex K.",
    content:
      '"Finding clothes that align with my personal style used to be a challenge until I discovered KEROSYNE. The range of options they offer is truly remarkable, catering to a variety of tastes and occasions.”',
    rating: 5,
    date: "August 14, 2023",
  },
  {
    id: 2,
    user: "Sarah M.",
    content: `"I'm blown away by the quality and style of the clothes I received from KEROSYNE. From casual wear to elegant dresses, every piece I've bought has exceeded my expectations.”`,
    rating: 5,
    date: "August 15, 2023",
  },
  {
      ...
      <main className="my-[50px] sm:my-[72px]">
        <div className="relative">
          ...
          <div className="absolute -top-4 right-4 xl:right-20 hidden lg:block pointer-events-auto">
            <FloatingShape shape="hanger" size={120} />
          </div>
        </div>
        ...
        <div className="mb-[50px] sm:mb-20 relative">
          ...
          <div className="absolute top-0 right-8 xl:right-24 hidden lg:block pointer-events-auto">
            <FloatingShape shape="torus" size={100} />
          </div>
        </div>
        <div className="relative">
          ...
          <div className="absolute bottom-4 right-8 xl:right-24 hidden lg:block pointer-events-auto">
            <FloatingShape shape="octahedron" size={90} />
          </div>
        </div>
      </main>
    </>
